        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               b =  ((EditText)findViewById(R.id.txte2)).getText().toString();
                JsonObjectRequest request = new JsonObjectRequest("https://maps.googleapis.com/maps/api/geocode/json?latlng="+a+ ","+b+ "&key=AIzaSyCa-yJBf2yHLW0f5u5Nlld4JHJ6m-48xiw", null,
